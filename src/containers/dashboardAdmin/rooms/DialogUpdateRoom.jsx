...
import { updateRoomService } from 'services/roomsService';
import { getAllCodesByTypeService } from 'services/allCodesService';

import { LANGUAGES } from 'utils';

const DialogUpdateRoom = props => {
    const { openDialogUpdate, handleToggleDialogUpdate, getAllRooms, currentRoom = {}, setIsLoading } = props;
    ...
    useEffect(() => {
        if (openDialogUpdate) {
            const initialValues = {
                ...
                roomTypeKey: currentRoom?.roomTypeKey || '',
            };
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            try {
                ...
                const response = await updateRoomService(axiosPrivate, currentRoom.id, values);
                if (response) {
                    setIsLoading(false);
                    setSubmitting(false);
                ...
                >
                    ...
                    <DialogTitle id="form-dialog-title">
                        <HeaderComponent
                            ...
                            subtitle={<FormattedMessage id="dashboardAdmin.rooms.updateSubtitle" />}
                        />
                    </DialogTitle>
                    <DialogContent>
