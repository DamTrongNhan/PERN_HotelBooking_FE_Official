...
import { Visibility, VisibilityOff, CloudUpload, Cancel } from '@mui/icons-material';
...
const DialogCreateUser = props => {
    const { openDialogCreate, handleToggleDialogCreate, getAllUsers, setIsLoading } = props;
    ...
    const formik = useFormik({
        ...
        onSubmit: async (values, { setSubmitting, resetForm }) => {
            try {
                ...
                const response = await createUserService(axiosPrivate, formData);
                if (response) {
                    setIsLoading(false);
                    setSubmitting(false);
                ...
                >
                    ...
                    <DialogTitle id="form-dialog-title">
                        <HeaderComponent
                            ...
                            subtitle={<FormattedMessage id="dashboardAdmin.users.createSubtitle" />}
                        />
                    </DialogTitle>
                            ...
                            <Grid mt={1} container spacing={3}>
                                ...
                                <Grid container xs={12} lg={12} sx={{ alignItems: 'center' }}>
                                    ...
                                    <Grid>
                                        ...
                                        >
                                            <Box p={1} sx={{ border: '2px solid #C2C2C2', borderRadius: '50%' }}>
                                                <Avatar
                                                    alt="Avatar"
